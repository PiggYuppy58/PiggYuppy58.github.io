...
<body>
    <div class="launcher-card">
        ...
        <div class="button-grid">
            <!-- original 14 buttons + 4 new minecraft versions (total 18) -->
            ...
            <!-- NEW MINECRAFT CLASSICS (4 buttons) -->
            <!-- 13 -->
            <a href="https://piggyuppy58.github.io/Minecraft%20Beta%201.7.3%20.html" class="game-btn" target="_blank" rel="noopener" data-en="⛏️ Minecraft Beta 1.7.3" data-ru="⛏️ Майнкрафт Бета 1.7.3">⛏️ Minecraft Beta 1.7.3</a>
            <!-- 14 -->
            <a href="https://piggyuppy58.github.io/Minecraft%20Beta%201.3%20.html" class="game-btn" target="_blank" rel="noopener" data-en="⛏️ Minecraft Beta 1.3" data-ru="⛏️ Майнкрафт Бета 1.3">⛏️ Minecraft Beta 1.3</a>
            <!-- 15 -->
            <a href="https://piggyuppy58.github.io/Minecraft%20Alpha%201.2.6%20.html" class="game-btn" target="_blank" rel="noopener" data-en="⛏️ Minecraft Alpha 1.2.6" data-ru="⛏️ Майнкрафт Альфа 1.2.6">⛏️ Minecraft Alpha 1.2.6</a>
            <!-- 16 -->
            <a href="https://piggyuppy58.github.io/Minecraft%201.5.2%20.html" class="game-btn" target="_blank" rel="noopener" data-en="⛏️ Minecraft 1.5.2" data-ru="⛏️ Майнкрафт 1.5.2">⛏️ Minecraft 1.5.2</a>

            <!-- remaining original buttons (14–18) -->
            <!-- 17 -->
        ...
        <footer>
            <span class="note" id="footer-note" data-en="🎯 buttons open directly — all games hosted on piggyuppy58.github.io" data-ru="🎯 кнопки открывают игры напрямую — все игры сделаны piggyuppy58">🎯 buttons open directly — all games created bypiggyuppy58</span>
        </footer>
    </div>
    ...
    <script>
        (function() {
            ...
            // initial language from default (EN is active)
            setLanguage('en');
        })();
    </script>
</body>
